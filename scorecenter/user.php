...
<html lang="en">
  ...
  <?php include_once 'navbar.php'; ?>
    ...
    <?php
    	if ($_SESSION['deletesuccessUser'] != null and $_SESSION['deletesuccessUser'] == '1') { ?>
    	<script type="text/javascript">displaySuccess('<strong>Saved: </strong>User has been deleted successfully!');</script>
   	<?php $_SESSION['deletesuccessUser'] = null; } ?>
